...
\pagestyle{plain}
  ...
  \chapter{Présentation de la bibliothèque}
  
    \section{Éléments demandés, codés et qui fonctionnent}
      Ensemble des structures
      \begin{itemize}
	\item Scalaire et anti quadvecteur
	\item Vecteur et anti trivecteur
	\item Bivecteur et anti bivecteur
	\item Trivecteur et anti bivecteur
	...
	\item Constructeur avec paramètre
	\item Opérateur d?affectation =
	\item Opérateur wedge \^{}
	\item Convertisseur en base duale \textasciitilde
	\item Opérateur << pour les std::cout
	\item Opérateur << pour l?initialisation
      \end{itemize}
      
      Programme d?exemple présentant les fonctionnalités
    \section{Éléments demandés, codés et mais qui ne fonctionnent pas}
    \section{Éléments demandés mais non codés}
    \section{Éléments non demandés, codés et qui fonctionnent}
      Fonctionnalité pour chaque structure 
      \begin{itemize}
	\item Opérateur de comparaison ==
	\item Opérateur de comparaison = !
	\item Opérateur anti wedge |(Pas fait mais ça peut être cool et facile)
	\item Accès à une valeur grâce au nom de la composante
      \end{itemize}

    \section{Éléments non demandés et non codés ou qui ne fonctionnent pas}
  ...
  \chapter{Fonctionnalités}
    \section{Opérateur \^{}}
      L?opérateur wedge se défini en fonction des grades des éléments. Dans P3, le grade maximal est 4. Il est donc possible de faire un wedge entre 2 élèments seulement si 
    \section{Opérateur \textasciitilde}
    \section{Opérateur << pour les std::cout}
